...
public class SeqScan implements DbIterator {
    ...
    public TupleDesc getTupleDesc() {
    	...
    	int numField = tupleD.numFields();
    	String[] fieldNames = new String [numField];
    	Type[] fieldTypes = new Type [numField];
    	for(int i =0; i < numField; i++) {
    		fieldTypes[i] = tupleD.getFieldType(i);
    		String prefix = getAlias()+".";
    		String name = tupleD.getFieldName(i);
    		fieldNames[i] = prefix +name;
    	}
