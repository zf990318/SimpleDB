...
public class Join extends Operator {
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        // some code goes here
        while (tuple != null || child1.hasNext() == true) {
            if (tuple == null && child1.hasNext() == true)
                tuple = child1.next();
            ...
            while (child2.hasNext() == true) {
                ...
                int fields1 = tuple.getTupleDesc().numFields();
                ...
                while(index1 < fields1) {
                    tuple3.setField(index1, tuple.getField(index1));
                    index1 += 1;
                }
                while(index2 < fields2) {
                    tuple3.setField(fields1 + index2, tuple2.getField(index2));
                    index2 += 1;
                }
